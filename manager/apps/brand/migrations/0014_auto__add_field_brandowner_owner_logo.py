...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandOwner.owner_logo'
        db.add_column(u'brand_owner', 'owner_logo',
                      self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, db_column=u'OWNER_LOGO', blank=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandOwner.owner_logo'
        db.delete_column(u'brand_owner', u'OWNER_LOGO')
