...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'BrandProposal.user'
        db.add_column(u'brand_proposal', 'user',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=1, to=orm['auth.User'], db_column=u'USER_ID'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandProposal.user'
        db.delete_column(u'brand_proposal', u'USER_ID')
