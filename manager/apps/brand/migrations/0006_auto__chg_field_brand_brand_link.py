...
class Migration(SchemaMigration):
    ...
    def backwards(self, orm):
        ...
        # Changing field 'Brand.brand_link'
        db.alter_column(u'brand', u'BRAND_LINK', self.gf('django.db.models.fields.CharField')(default='', max_length=255, db_column=u'BRAND_LINK'))

    models = {
        u'brand.brand': {
            'Meta': {'object_name': 'Brand', 'db_table': "u'brand'"},
            'brand_link': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_column': "u'BRAND_LINK'", 'blank': 'True'}),
