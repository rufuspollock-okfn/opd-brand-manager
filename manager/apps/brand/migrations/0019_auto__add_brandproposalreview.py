...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding model 'BrandProposalReview'
        db.create_table(u'brand_proposal_review', (
            (u'id', self.gf('django.db.models.fields.AutoField')(primary_key=True)),
            ('proposal_cd', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['brand.BrandProposal'], db_column=u'PROPOSAL_CD')),
            ('user', self.gf('django.db.models.fields.related.ForeignKey')(to=orm['auth.User'], db_column=u'USER_ID')),
            ('review_dt', self.gf('django.db.models.fields.DateTimeField')(auto_now_add=True, db_column=u'REVIEW_DT', blank=True)),
            ('comments', self.gf('django.db.models.fields.TextField')(null=True, db_column=u'COMMENTS', blank=True)),
        ))
        db.send_create_signal(u'brand', ['BrandProposalReview'])


    def backwards(self, orm):
        # Deleting model 'BrandProposalReview'
        db.delete_table(u'brand_proposal_review')
