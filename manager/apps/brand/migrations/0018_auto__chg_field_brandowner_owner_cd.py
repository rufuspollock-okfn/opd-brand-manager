...
class Migration(SchemaMigration):
    ...
    # Nice ticket 407 for setting a field to auto in South with PSQL
    # http://south.aeracode.org/ticket/407

    def forwards(self, orm):
        db.execute("CREATE SEQUENCE brand_owner_OWNER_CD_seq")
        db.execute("SELECT setval('brand_owner_OWNER_CD_seq', (SELECT MAX(\"OWNER_CD\") FROM brand_owner))")
        db.execute("ALTER TABLE brand_owner ALTER COLUMN \"OWNER_CD\" SET DEFAULT nextval('brand_owner_OWNER_CD_seq'::regclass)")


    def backwards(self, orm):
        db.execute("ALTER TABLE brand_owner ALTER COLUMN \"OWNER_CD\" DROP DEFAULT")
        db.execute("DROP SEQUENCE brand_owner_OWNER_CD_seq")
