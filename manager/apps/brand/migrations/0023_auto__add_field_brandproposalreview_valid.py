...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.add_column(u'brand_proposal_review', 'valid',
                      self.gf('django.db.models.fields.BooleanField')(default=False, db_column=u'VALID'),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'BrandProposalReview.valid'
        db.delete_column(u'brand_proposal_review', u'VALID')
