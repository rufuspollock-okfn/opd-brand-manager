...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding unique constraint on 'BrandProposalReview', fields ['proposal_cd', 'user']
        db.create_unique(u'brand_proposal_review', [u'PROPOSAL_CD', u'USER_ID'])


    def backwards(self, orm):
        # Removing unique constraint on 'BrandProposalReview', fields ['proposal_cd', 'user']
        db.delete_unique(u'brand_proposal_review', [u'PROPOSAL_CD', u'USER_ID'])
