...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Changing field 'Brand.comments'
        db.alter_column(u'brand', u'COMMENTS', self.gf('django.db.models.fields.TextField')(null=True, db_column=u'COMMENTS'))

    def backwards(self, orm):

        # Changing field 'Brand.comments'
        db.alter_column(u'brand', u'COMMENTS', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column=u'COMMENTS'))
