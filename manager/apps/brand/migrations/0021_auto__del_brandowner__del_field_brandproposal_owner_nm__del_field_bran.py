...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Deleting field 'BrandProposal.owner_nm'
        db.delete_column(u'brand_proposal', u'OWNER_NM')
    ...
    def backwards(self, orm):
        ...
        db.create_table(u'brand_owner', (
            ...
            ('owner_link', self.gf('django.db.models.fields.URLField')(max_length=255, null=True, db_column=u'OWNER_LINK', blank=True)),
            ('owner_cd', self.gf('django.db.models.fields.AutoField')(primary_key=True, db_column=u'OWNER_CD')),
            ('owner_logo', self.gf('django.db.models.fields.files.ImageField')(max_length=100, null=True, db_column=u'OWNER_LOGO', blank=True)),
        ))
        db.send_create_signal(u'brand', ['BrandOwner'])


        # User chose to not deal with backwards NULL issues for 'BrandProposal.owner_nm'
        raise RuntimeError("Cannot reverse this migration. 'BrandProposal.owner_nm' and its values cannot be restored.")
        
        # The following code is provided here to aid in writing a correct migration        # Adding field 'BrandProposal.owner_nm'
        db.add_column(u'brand_proposal', 'owner_nm',
                      self.gf('django.db.models.fields.CharField')(max_length=255, db_column=u'OWNER_NM'),
                      keep_default=False)

        # Adding field 'Brand.owner_cd'
        db.add_column(u'brand', 'owner_cd',
                      self.gf('django.db.models.fields.related.ForeignKey')(to=orm['brand.BrandOwner'], null=True, db_column=u'OWNER_CD', blank=True),
                      keep_default=False)
